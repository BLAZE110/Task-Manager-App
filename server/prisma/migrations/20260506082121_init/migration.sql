...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('ASSIGNMENT', 'OVERDUE', 'COMMENT', 'PROJECT_INVITE');

-- CreateEnum
CREATE TYPE "ActionType" AS ENUM ('CREATED', 'STATUS_CHANGED', 'ASSIGNED', 'COMMENTED', 'DELETED', 'UPDATED');
